...
2. Gather required information for use with the CloudFormation Templates to deploy the solution. Template: HCOM-CF-Ops-Foundation-Step-2.yaml
    ...
    * AWS IAM Role used by Platform Administrators to access and manage through AWS console. (must already exists and used by Platform Ops team) <<< arn:aws:iam::821020061217:role/aws-reserved/sso.amazonaws.com/AWSReservedSSO_AdministratorAccess_9405213f83933cdd >>>
